...
const About = () => {
  return <section id="sobre" className="py-12 sm:py-16 md:py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-3 sm:mb-4">Nossa história</h2>
          <p className="text-sm sm:text-base text-center text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
            Uma jornada de paixão, família e dedicação ao transporte rodoviário
          </p>
          
          <div className="flex justify-center mb-8 sm:mb-12">
            <img src={logoHistory} alt="Imports Costa Logo" className="h-32 sm:h-48 md:h-64 w-auto object-contain" />
          </div>

          <div className="bg-card rounded-lg p-4 sm:p-6 md:p-8 lg:p-12 shadow-lg mb-8 sm:mb-12">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-card rounded-lg p-4 sm:p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <div className="bg-card rounded-lg p-4 sm:p-6 text-center shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Paixão</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
                Amor pelo transporte e dedicação em cada atendimento
              </p>
            </div>

            <div className="bg-card rounded-lg p-4 sm:p-6 text-center shadow-md hover:shadow-lg transition-shadow sm:col-span-2 md:col-span-1">
              <div className="w-14 h-14 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="text-accent" size={28} />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Qualidade</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
